...
*******************************************************************************/
/*******************************************************************************
* File Name   : sample_rspi_cmdlist.c
* $Rev: 1330 $
* $Date:: 2015-02-17 16:07:56 +0900#$
* Description : Renesas Serial Peripheral Interface(RSPI) sample program - Command list
*******************************************************************************/
...
******************************************************************************/
static const command_list_t sample_rspi_cmd_list[] = 
{
    {"1",       Sample_RSPI_EepAccess,  NULL},  /* 1: RSPI write and read sample */
    {"HELP",    Sample_RSPI_Help,       NULL},  /* Display command help          */
    {"EXIT",    Sample_RSPI_Exit,       NULL},  /* Exit RSPI sample              */
    {NULL,      NULL,                   NULL}
};

/******************************************************************************
* Function Name: Sample_RSPI_Help
...
int32_t Sample_RSPI_Help(int32_t argc, char_t ** argv)
{
    ...
    {
        printf("\n");
        printf("  1    : EEPROM access\n");
        printf("          - Bit rate : 2.78Mbps\n");
        printf("  EXIT : Exit RSPI sample\n");
        printf("\n");
    }
    else
    {
...
/******************************************************************************
* Function Name: Sample_RSPI_GetCmdList
