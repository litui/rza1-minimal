...
*******************************************************************************/
/*******************************************************************************
* File Name   : sample_riic_cmdlist.c
* $Rev: 1330 $
* $Date:: 2015-02-17 16:07:56 +0900#$
* Description : RIIC sample program - Command list
*******************************************************************************/
...
******************************************************************************/
static const command_list_t sample_riic_cmd_list[] = 
{
    {"1",       Sample_RIIC_EepAccess,      NULL},  /* 1: Read/Write sample of RIIC EEPROM */
    {"HELP",    Sample_RIIC_Help,           NULL},  /* Display command help                */
    {"EXIT",    Sample_RIIC_Exit,           NULL},  /* Exit RIIC sample                    */
    {NULL,      NULL,                       NULL}
};

/******************************************************************************
* Function Name: Sample_RIIC_Help
...
int32_t Sample_RIIC_Help(int32_t argc, char_t ** argv)
{
    ...
    if (1 == argc)
    {
        ...
        printf("          - Bit rate : 100kbps\n");
        printf("  EXIT : Exit RIIC sample\n");
        printf("\n");
    }
    else
    {
...
/******************************************************************************
* Function Name: Sample_RIIC_GetCmdList
