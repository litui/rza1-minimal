...
#define INTC_ID_LIN0_INT_T      (331)   /* LIN interface                      */
#define INTC_ID_LIN0_INT_R      (332)   /*                                    */
#define INTC_ID_LIN0_INT_S      (333)   /*                                    */
#define INTC_ID_LIN0_INT_M      (334)   /*                                    */
#define INTC_ID_LIN1_INT_T      (335)   /*                                    */
#define INTC_ID_LIN1_INT_R      (336)   /*                                    */
#define INTC_ID_LIN1_INT_S      (337)   /*                                    */
#define INTC_ID_LIN1_INT_M      (338)   /*                                    */
